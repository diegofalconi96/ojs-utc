<?php return array (
  ...
  'boardEnabled' => true,
  'categories' => NULL,
  'contactEmail' => 'juan.mato@utc.edu.ec',
  'contactFax' => '',
  ...
  'emailHeader' => 'El siguiente mensaje se está enviando a nombre de INPOS.
________________________________________________________________________',
  'emailSignature' => '________________________________________________________________________
INVPOS
http://investigacion.utc.edu.ec/revistasutc/index.php/invpos',
  ...
  'publisherUrl' => 'http://investigacion.utc.edu.ec/revistasutc/index.php/inpos',
  'publishingMode' => 0,
  ...
  'supportEmail' => 'juan.mato@utc.edu.ec',
  'supportName' => 'PhD. Juan Mato Tamayo',
  'supportPhone' => '0984144999',
  ...
  'authorGuidelines' => 
  array (
    'es_ES' => '<ul><li>La revista INVPOS recibirá para su revisión y posterior publicación artículos correctamente redactados, sin errores gramaticales, ni ortográficos.</li><li>Los artículos enviados para la posible publicación deberán ser originales, inéditos y no estar en proceso de revisión ni aprobación en otra revista.</li><li>Los artículos deberán tener una extensión máxima  de 20 páginas. El tipo de letra será Times New Roman de doce puntos a espacio y medio en tamaño de papel A4. En un formulario aparte el autor o autores, escribirá su nombre, máximo grado académico, filiación institucional o laboral, el título del artículo, fecha de envío, dirección postal y correo electrónico.</li><li>La revista recibe artículos en español e inglés, sin embargo solo se aceptan tres tipos de trabajos: artículos producto de una investigación científica o tecnológica, notas científicas y artículos de revisión.</li><li>Los primeros se refieren a resultados de investigación originales, organizados en seis apartados (introducción, metodología, resultados, discusión, conclusiones y referencias bibliográficas).</li><li>Los artículos de revisión ofrecen resultados de investigación sobre un tema concreto desde una perspectiva crítica y analítica recurriendo a debates y referencias bibliográficas de carácter científico.</li><li>Dentro de la nota científica se exponen observaciones que sean de relevancia científica, basadas en algún tema o estudio sencillo cuyos aportes o resultados sean relevantes para ser socializados. </li></ul><p>Todos los artículos sin excepción serán revisados bajo el sistema doble ciego que realizarán pares evaluadores nacionales e internacionales, internos o externos a la Universidad Técnica de Cotopaxi, los cuales se encargarán de realizar observaciones y sugerencias a los artículos para que estos cumplan con la calidad científica; en caso de que los artículos pasen el proceso de revisión por pares los autores deberán enviar una versión final corregida incluyendo las observaciones de los árbitros.</p><h4>Sobre las referencias bibliográficas: se utilizará el estilo IEEE</h4><p> </p><h5>Estilo de citas y referencias IEEE</h5><p><br /> Es importante hacer un uso responsable, ético y legal de la información que se utiliza cuando se elabora un trabajo académico. Al incluir las referencias bibliográficas identificamos las ideas e información que han sido tomadas de otros autores. Si además se emplea un estilo de cita normalizado se favorece el reconocimiento de la fuente empleada para que cualquier otra persona pueda localizar esos documentos.<br /> El estilo de cita IEEE es el recomendado por el Institute of Electrical and Electronics Engineers.<br /> <span style="text-decoration: underline;">Características:</span><br /> De acuerdo con las normas de estilo de IEEE, las fuentes consultadas se indican con un número dentro del texto. El número remite a una relación completa al final del documento en el que se relaciona toda la bibliografía empleada.<br /> Citar dentro del texto:<br /> El uso de referencias dentro del texto debe seguir unas normas.<br /> 1. Las referencias deben estar numeradas en el orden en que aparecen en el documento<br /> 2. Una vez asignado un número a una referencia dada, el mismo número debe emplearse en todas las ocasiones en que ese documento sea citado en el texto<br /> 3. Cada número de referencia debe estar entre corchetes [ ], por ejemplo, "...el fin de la investigación [12]..."<br /> 4. No es necesario mencionar al autor en la referencia a menos que sea relevante en el texto mismo.<br /> 5. En el cuerpo del documento tampoco se mencionará la fecha de publicación<br /> 6. No es necesario incluir la palabra "referencia", por ejemplo, "...en la referencia [27]...": basta con indicar "...en [27]..."<br /> 7. Para citar más de una fuente a la vez es preferible consignar cada una de ellas con sus propios corchetes, por ejemplo, "como indican varios estudios [1], [3], [5]..." en lugar de "como indican diversos estudios [1, 3, 5]..."<br /> Lista de referencias:<br /> Todas las referencias incluidas en el texto se presentan al final del documento en una sección denominada "Referencias", ordenadas numéricamente según el orden de aparición en el texto. Ejemplo:<br /> [1] B. Klaus and P. Horn, Robot vision.Cambridge, MA: MIT Press, 1966.<br /> [2] L. Stein, "Random pattersn", in Computer and yoy, J.S. Brake, Ed. New York: Wiley, 1994, pp.55-70.<br /> [3] R. L. Myers, "Parametric oscillators and nonlinear materials", in Nonlinear Optics, vol. 4, P.G. Harper and B.S. Wherret, Eds. San Francisco, CA: Academic, 1977, pp. 47-160.<br /> 1. La lista de referencias debe ofrecer la información necesaria para identificar y poder recuperar las fuentes utilizadas<br /> 2. Es imprescindible que cada una de las citas que se hayan intercalado en el texto tenga su referencia correspondiente en la lista final y, a la inversa, toda entrada en la lista de referencias debe haber sido citada dentro del texto<br /> 3. Los datos para redactar la cita se tomarán del documento original al que se refieren<br /> 4. Los nombres de persona deben abreviarse poniendo solo las iniciales<br /> 5. En el caso de obras anónimas, el primer elemento de la cita será el título<br /> 6. Si el autor es una entidad se indicará el nombre de la misma tal y como aparece en la fuente<br /> 7. Cada palabra importante (sustantivos, adjetivos, verbos, adverbios) en el título de un libro, revista o congreso debe llevar la inicial en mayúsculas.<br /> 8. Solo va en mayúsculas la inicial de la primera palabra del título de un artículo o capítulo (excepto en el caso de nombres propios, siglas, etc.)<br /> 9. La "v" de "Volumen" va en mayúsculas si se trata de un libro, pero en minúscula si es una revista.<br /> 10. La puntuación de los títulos de artículos va dentro de las comillas.</p>',
  ),
  'authorInformation' => 
  array (
    'es_ES' => '¿Está interesado en publicar en la revista? Se recomienda revisar la página <a href="/revistasutc/index.php/inpos/about">Acerca de la revista</a> para consultar las políticas de sección de la revista, así como las <a href="/revistasutc/index.php/inpos/about/submissions#authorGuidelines">Directrices del autor/a</a>. Los autores/as deben <a href="/revistasutc/index.php/inpos/user/register">registrarse</a> en la revista antes de publicar o, si ya están registrados, pueden simplemente <a href="/revistasutc/index.php/index/login">iniciar sesión</a> y comenzar el proceso de cinco pasos.',
  ),
  ...
  array (
    'es_ES' => 'Dirección de Posgrado de la Universidad Técnica de Cotopaxi (UTC), cantón Latacunga, El Ejido, sector San Felipe. País: Ecuador. Provincia: Cotopaxi. Cantón: Latacunga. Teléfonos: 593 (03) 2252-307 / 2252-205 Extensión: 209. Fax: 593 (03) 2810-295.',
  ),
  'contactTitle' => 
  array (
    'es_ES' => 'PhD.',
  ...
  'editorialTeam' => 
  array (
    'es_ES' => '<div id="group"><h4>CONSEJO EDITORIAL</h4><p>Cristian F. Tinajero, Universidad Técnica de Cotopaxi, Ecuador</p><p>Idalia Pacheco, Universidad Técnica de Cotopaxi, Ecuador</p><p>Carlos Torres Miño, Universidad Técnica de Cotopaxi, Ecuador</p></div>',
  ),
  ...
  array (
    'es_ES' => 
    array (
      'name' => 'INVPOS CORRECCION 2-01.png',
      'uploadName' => 'journalThumbnail_es_ES.png',
      'width' => 2480,
      'height' => 3508,
      'mimeType' => 'image/png',
      'dateUploaded' => '2018-10-01 15:35:22',
    ),
  ),
  ...
  array (
    'es_ES' => 'ciencias sociales, ciencias técnicas, recursos naturales, ciencias de la vida',
  ),
  'name' => 
  array (
    'es_ES' => 'INVPOS',
  ...
  'readerInformation' => 
  array (
    'es_ES' => 'Animamos a los lectores/as a registrarse en el servicio de notificación de publicaciones de la revista. Utilice el enlace <a href="/revistasutc/index.php/inpos/user/register">Registro</a> de la parte superior de la página de inicio de la revista. Como resultado del registro, el lector/a recibirá por correo electrónico la Tabla de contenidos de cada número de la revista. Esta lista también permite que se le atribuya a la revista un cierto nivel de apoyo o número de lectores/as. Consulte la <a href="/revistasutc/index.php/inpos/about/submissions#privacyStatement">Declaración de privacidad</a> de la revista, que garantiza a los lectores/as que sus nombres y direcciones de correo electrónico no se usarán con otros fines.',
  ),
  'refLinkInstructions' => 
  array (
  ...
  'searchDescription' => 
  array (
    'es_ES' => 'La Revista INVPOS es una publicación periódica científica a texto completo bianual, Su misión es contribuir a la difusión de la investigación y el conocimiento a través de la publicación de artículos originales de alta calidad relacionados con las actividades en las áreas de Desarrollo Local, Educación, Administración de Empresas, Sistemas de Información, Veterinaria, Sanidad Vegetal, Lingüística, Eléctrica, Electromecánica, Industrial y otras',
  ),
  'searchKeywords' => 
  array (
    'es_ES' => 'Desarrollo Local; Educación; Administración de Empresas; Sistemas de Información; Veterinaria; Sanidad Vegetal; Lingüística; Eléctrica; Electromecánica; Industrial',
  ),
  'submissionChecklist' => 
  array (
    'es_ES' => 
    array (
      ...
      array (
        'order' => '3',
        'content' => '<span>Los artículos están correctamente redactados, sin errores gramaticales, ni ortográficos.</span>',
      ),
      3 => 
      array (
        'order' => '4',
        'content' => '<span>Los artículos deberán tener una extensión que no deberán exceder las 20 páginas. El tipo de letra será Times New Roman de doce puntos, a espacio y medio, en tamaño de papel A4</span>.',
      ),
      4 => 
      array (
        'order' => '5',
        'content' => 'El texto se adhiere a los requisitos estilísticos y biliográficos resumidos en las <a href="/revistasutc/index.php/inpos/about/submissions#authorGuidelines" target="_new">Directrices del autor/a</a>, que aparecen en Acerca de la revista.',
      ),
      5 => 
      array (
        'order' => '6',
        'content' => 'Si se envía a una sección evaluada por pares de la revista, deben seguirse las instrucciones en <a href="javascript:openHelp(\'http://investigacion.utc.edu.ec/revistasutc/index.php/inpos/help/view/editorial/topic/000044\')">Asegurar una evaluación anónima</a>.',
      ),
    ),
  ),
