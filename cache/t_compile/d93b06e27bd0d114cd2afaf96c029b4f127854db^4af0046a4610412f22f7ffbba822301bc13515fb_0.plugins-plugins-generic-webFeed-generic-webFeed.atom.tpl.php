<?php
/* Smarty version 3.1.33, created on 2023-06-13 20:09:51
  from 'plugins-plugins-generic-webFeed-generic-webFeed:atom.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6488cd0f6dad51_66354256',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4af0046a4610412f22f7ffbba822301bc13515fb' => 
    array (
      0 => 'plugins-plugins-generic-webFeed-generic-webFeed:atom.tpl',
      1 => 1575681927,
...
function content_6488cd0f6dad51_66354256 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/var/www/ojs/lib/pkp/lib/vendor/smarty/smarty/libs/plugins/modifier.date_format.php','function'=>'smarty_modifier_date_format',),1=>array('file'=>'/var/www/ojs/lib/pkp/lib/vendor/smarty/smarty/libs/plugins/modifier.regex_replace.php','function'=>'smarty_modifier_regex_replace',),));
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	<updated><?php echo smarty_modifier_regex_replace(smarty_modifier_date_format($_smarty_tpl->tpl_vars['latestDate']->value,"%Y-%m-%dT%T%z"),"/00"."$"."/",":00");?>
		...
		<?php if ($_smarty_tpl->tpl_vars['journal']->value->getSetting('contactName')) {?>
		<author>
			<name><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( preg_replace('!\s+!u', ' ',$_smarty_tpl->tpl_vars['journal']->value->getSetting('contactName')),"html" ));?>
</name>
			<?php if ($_smarty_tpl->tpl_vars['journal']->value->getSetting('contactEmail')) {?>
			<email><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( preg_replace('!\s+!u', ' ',$_smarty_tpl->tpl_vars['journal']->value->getSetting('contactEmail')),"html" ));?>
</email>
			<?php }?>
		</author>
	<?php }?>
...
?>
			<entry>
								<id><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('page'=>"article",'op'=>"view",'path'=>$_smarty_tpl->tpl_vars['article']->value->getBestArticleId()),$_smarty_tpl ) );?>
</id>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
				<link rel="alternate" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('page'=>"article",'op'=>"view",'path'=>$_smarty_tpl->tpl_vars['article']->value->getBestArticleId()),$_smarty_tpl ) );?>
" />

				<?php if ($_smarty_tpl->tpl_vars['article']->value->getLocalizedAbstract()) {?>
					<summary type="html" xml:base="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('page'=>"article",'op'=>"view",'path'=>$_smarty_tpl->tpl_vars['article']->value->getBestArticleId()),$_smarty_tpl ) );?>
