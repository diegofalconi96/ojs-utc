...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6488bac30d2710_54662402',
...
function content_6488bac30d2710_54662402 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormSection', array('label'=>"installer.databaseCharset"));
$_block_repeat=true;
echo $_block_plugin12->smartyFBVFormSection(array('label'=>"installer.databaseCharset"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"select",'id'=>"databaseCharset",'from'=>$_smarty_tpl->tpl_vars['databaseCharsetOptions']->value,'selected'=>$_smarty_tpl->tpl_vars['databaseCharset']->value,'translate'=>false,'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['SMALL']),$_smarty_tpl ) );?>

			<?php $_block_repeat=false;
echo $_block_plugin12->smartyFBVFormSection(array('label'=>"installer.databaseCharset"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php $_block_repeat=false;
...
$_block_repeat=true;
echo $_block_plugin13->smartyFBVFormArea(array('id'=>"fileSettingsFormArea",'title'=>"installer.fileSettings"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin14->smartyFBVFormSection(array('label'=>"installer.filesDir",'description'=>"installer.filesDirInstructions"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin14->smartyFBVFormSection(array('label'=>"installer.filesDir",'description'=>"installer.filesDirInstructions"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin13->smartyFBVFormArea(array('id'=>"fileSettingsFormArea",'title'=>"installer.fileSettings"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin15->smartyFBVFormArea(array('id'=>"databaseSettingsFormArea",'title'=>"installer.databaseSettings"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin16->smartyFBVFormSection(array('label'=>"installer.databaseDriver",'description'=>"installer.databaseDriverInstructions"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin16->smartyFBVFormSection(array('label'=>"installer.databaseDriver",'description'=>"installer.databaseDriverInstructions"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin17->smartyFBVFormSection(array('label'=>"installer.databaseHost"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin17->smartyFBVFormSection(array('label'=>"installer.databaseHost"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin18->smartyFBVFormSection(array('label'=>"installer.databaseUsername"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin18->smartyFBVFormSection(array('label'=>"installer.databaseUsername"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin19->smartyFBVFormSection(array('label'=>"installer.databasePassword"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin19->smartyFBVFormSection(array('label'=>"installer.databasePassword"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin20->smartyFBVFormSection(array('label'=>"installer.databaseName"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin20->smartyFBVFormSection(array('label'=>"installer.databaseName"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin21->smartyFBVFormSection(array('list'=>"true"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin21->smartyFBVFormSection(array('list'=>"true"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php $_block_repeat=false;
echo $_block_plugin15->smartyFBVFormArea(array('id'=>"databaseSettingsFormArea",'title'=>"installer.databaseSettings"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin22->smartyFBVFormArea(array('id'=>"oaiSettingsFormArea",'title'=>"installer.oaiSettings"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin23->smartyFBVFormSection(array('label'=>"installer.oaiRepositoryId",'description'=>"installer.oaiRepositoryIdInstructions"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin23->smartyFBVFormSection(array('label'=>"installer.oaiRepositoryId",'description'=>"installer.oaiRepositoryIdInstructions"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php $_block_repeat=false;
echo $_block_plugin22->smartyFBVFormArea(array('id'=>"oaiSettingsFormArea",'title'=>"installer.oaiSettings"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>

		<?php $_block_plugin24 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0][0] : null;
if (!is_callable(array($_block_plugin24, 'smartyFBVFormArea'))) {
throw new SmartyException('block tag \'fbvFormArea\' not callable or registered');
}
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormArea', array('id'=>"beaconArea",'title'=>"installer.beacon"));
$_block_repeat=true;
echo $_block_plugin24->smartyFBVFormArea(array('id'=>"beaconArea",'title'=>"installer.beacon"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormSection', array('list'=>true));
$_block_repeat=true;
echo $_block_plugin25->smartyFBVFormSection(array('list'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin25->smartyFBVFormSection(array('list'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php $_block_repeat=false;
echo $_block_plugin24->smartyFBVFormArea(array('id'=>"beaconArea",'title'=>"installer.beacon"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
