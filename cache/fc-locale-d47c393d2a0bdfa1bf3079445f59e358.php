<?php return array (
  ...
  'plugins.importexport.native.import.instructions' => 'Por favor, seleccione un archivo XML para subir y haga clic en "Iniciar subida". Cuando se haya completado la subida del archivo, haga clic en "OK" para importarlo al gestor.',
  'plugins.importexport.native.export' => 'Exportar',
  'plugins.importexport.native.results' => 'Resultados',
  'plugins.inportexport.native.uploadFile' => 'Por favor, suba un archivo en "Importar" para continuar.',
